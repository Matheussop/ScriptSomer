...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy2.setHeightForWidth(self.detailLabel.sizePolicy().hasHeightForWidth())
        self.detailLabel.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.buttonSend.sizePolicy().hasHeightForWidth())
        self.buttonSend.setSizePolicy(sizePolicy3)
        ...
        sizePolicy2.setHeightForWidth(self.monthLabel.sizePolicy().hasHeightForWidth())
        self.monthLabel.setSizePolicy(sizePolicy2)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 772, 193))
